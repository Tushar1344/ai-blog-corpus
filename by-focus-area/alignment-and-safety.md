...
- [Responsible scaling & safety policy](#responsible-scaling-and-policy) (26)
- [Constitutional methods & self-critique](#constitutional-and-self-critique) (11)
...
- [Reward hacking, monitorability & honesty](#reward-hacking-and-sycophancy) (10)
- [General safety research](#safety-research-general) (7)
- [Other alignment & safety](#fallback-alignment) (35)

---

## <a id="system-cards"></a>System cards & model cards
...
- **ID:** `oai-r-openai-o1-system-card`
- **Company:** OpenAI
...
- **ID:** `oai-r-deep-research-system-card`
- **Company:** OpenAI
...
- **ID:** `oai-r-gpt-4o-image-generation-system-card-addendum`
- **Company:** OpenAI
...
### System Cards A New Resource For Understanding How Ai Systems

- **ID:** `meta-r-system-cards-a-new-resource-for-understanding-how-ai-systems-`
- **Company:** Meta AI / FAIR
- **Link:** https://ai.meta.com/blog/system-cards-a-new-resource-for-understanding-how-ai-systems-/
- **Date:** _date unknown_
- **Track:** research
- **Contribution type:** _(uncategorized)_
...
- **ID:** `ant-r-economic-index-march-2026-report`
- **Company:** Anthropic
...
- **ID:** `ant-r-india-brief-economic-index`
- **Company:** Anthropic
...
- **ID:** `ant-r-anthropic-economic-index-january-2026-report`
- **Company:** Anthropic
...
- **ID:** `ant-r-economic-index-primitives`
- **Company:** Anthropic
...
- **ID:** `ant-r-economic-index-geography`
- **Company:** Anthropic
...
- **ID:** `ant-r-emergent-misalignment-reward-hacking`
- **Company:** Anthropic
...
- **ID:** `ant-r-auditing-hidden-objectives`
- **Company:** Anthropic
...
- **ID:** `ant-r-probes-catch-sleeper-agents`
- **Company:** Anthropic
...
- **ID:** `oai-r-deliberative-alignment`
- **Company:** OpenAI
...
- **ID:** `ant-r-next-generation-constitutional-classifiers`
- **Company:** Anthropic
...
- **ID:** `ant-r-many-shot-jailbreaking`
- **Company:** Anthropic
...
- **ID:** `ant-r-automated-alignment-researchers`
- **Company:** Anthropic
...
- **ID:** `ant-e-eval-awareness-browsecomp`
- **Company:** Anthropic
...
- **ID:** `ant-r-disempowerment-patterns`
- **Company:** Anthropic
...
- **ID:** `oai-r-chain-of-thought-monitoring`
- **Company:** OpenAI
...
- Anthropic Education Report measuring 'AI fluency': taxonomy of 24 behaviors (11 observable) representing effective human-AI collaboration
- Privacy-preserving study of 9,830 Claude.ai conversations over a week in Jan 2026
- Key findings: iteration/refinement is the strongest correlate of all other fluency behaviors (2.67x more behaviors)
- Users building artifacts become more directive but less evaluative — less likely to question reasoning (-3.1pp) or identify missing context (-5.2pp)
- Provides a baseline to track how user fluency evolves over time with model capability.
...
- Uses privacy-preserving analysis of 100,000 Claude.ai conversations to estimate labor productivity impact
- Claude estimates tasks would take ~90 min without AI and that Claude speeds them up by ~80%
- Extrapolates to ~1.8% annual US labor productivity growth over the next decade (roughly double recent run rate), though caveats apply
- Matches tasks to O*NET/BLS for cost and occupation-level variation (legal/mgmt high
- food prep low)
- Methodological advance for measuring AI's economic impact at population scale from real use.
...
- Extends adversarial and virtual adversarial training to text by perturbing word embeddings rather than one-hot inputs
- Applied to RNN sentence classifiers in supervised and semi-supervised settings
- Achieves SOTA on multiple text benchmarks
- Improves learned word embeddings and reduces overfitting
- Matters as adversarial regularization for NLP.
...
- Derives bias-free action-dependent baseline for policy gradient variance reduction
- Exploits structural form of stochastic policy without added MDP assumptions
- Scales to high-dimensional control (2000-dim target matching, hand manipulation)
- Extends to partially-observed and multi-agent tasks
- Matters as a practical variance-reduction technique for deep RL.
...
- Proves precise equivalence between entropy-regularized Q-learning and policy gradient methods
- Connects Q-learning to natural policy gradient
- Shows entropy-regularized variants match or beat standard RL on Atari
- Constructs a Q-learning variant matching A3C dynamics without target network or epsilon-greedy
- Matters as a theoretical unification of two major RL families.
...
- Shows mathematical equivalence between max-entropy IRL and a GAN variant where generator density is passed to the discriminator
- Frames max-entropy IRL as a special case of energy-based models
- Unifies GANs, IRL, and EBMs to enable transferable ideas across communities
- Targets more stable/scalable algorithms in all three families
- Matters as a theoretical bridge between generative modeling and imitation learning.
