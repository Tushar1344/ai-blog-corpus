...
| ? | Google DeepMind | [A Generalist Agent](../by-focus-area/agentic-systems.md#dm-r-a-generalist-agent) | `dm-r-a-generalist-agent` |
| ? | Google DeepMind | [Discovering When An Agent Is Present In A System](../by-focus-area/agentic-systems.md#dm-r-discovering-when-an-agent-is-present-in-a-system) | `dm-r-discovering-when-an-agent-is-present-in-a-system` |
...
| ? | Google DeepMind | [Safety First Ai For Autonomous Data Centre Cooling And Industrial Control](../by-focus-area/agentic-systems.md#dm-r-safety-first-ai-for-autonomous-data-centre-cooling-and-industrial-control) | `dm-r-safety-first-ai-for-autonomous-data-centre-cooling-and-industrial-control` |
