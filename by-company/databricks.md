...
| 2023-04-26 | [Training Stable Diffusion from Scratch for <$50k with MosaicML (Part 2)](../by-focus-area/pretraining-and-architecture.md#dbx-r-stable-diffusion-2) | `dbx-r-stable-diffusion-2` |
| 2023-03-09 | [MosaicBERT: Pretraining BERT from Scratch for $20](../by-focus-area/pretraining-and-architecture.md#dbx-r-mosaicbert) | `dbx-r-mosaicbert` |
| 2023-02-09 | [MosaicML StreamingDataset: Fast, Accurate Streaming of Training Data from Cloud Storage](../by-focus-area/pretraining-and-architecture.md#dbx-e-mosaicml-streamingdataset) | `dbx-e-mosaicml-streamingdataset` |
| 2022-11-17 | [5x Faster Image Segmentation Training with MosaicML Recipes](../by-focus-area/pretraining-and-architecture.md#dbx-r-mosaic-image-segmentation) | `dbx-r-mosaic-image-segmentation` |
| 2022-11-09 | [MosaicML Delivers Leading NLP Performance in MLPerf v2.1](../by-focus-area/pretraining-and-architecture.md#dbx-r-mlperf-nlp-nov2022) | `dbx-r-mlperf-nlp-nov2022` |
| 2022-09-29 | [Mosaic LLMs: GPT-3 quality for <$500k](../by-focus-area/pretraining-and-architecture.md#dbx-r-gpt-3-quality-for-500k) | `dbx-r-gpt-3-quality-for-500k` |
| 2022-07-28 | [Behind the Scenes: Setting a Baseline for Image Segmentation Speedups](../by-focus-area/pretraining-and-architecture.md#dbx-r-behind-the-scenes) | `dbx-r-behind-the-scenes` |
| 2022-07-18 | [Mosaic ResNet Deep Dive](../by-focus-area/pretraining-and-architecture.md#dbx-r-mosaic-resnet-deep-dive) | `dbx-r-mosaic-resnet-deep-dive` |
| 2022-06-29 | [MosaicML Satisfies the Need for Speed with MLPerf Results](../by-focus-area/pretraining-and-architecture.md#dbx-r-mlperf-2022) | `dbx-r-mlperf-2022` |
| 2022-06-09 | [Blazingly Fast Computer Vision Training with the Mosaic ResNet and Composer](../by-focus-area/pretraining-and-architecture.md#dbx-r-mosaic-resnet) | `dbx-r-mosaic-resnet` |
| 2022-04-08 | [Efficiently Estimating Pareto Frontiers with Cyclic Learning Rate Schedules](../by-focus-area/pretraining-and-architecture.md#dbx-r-efficiently-estimating-pareto-frontiers) | `dbx-r-efficiently-estimating-pareto-frontiers` |
| ? | [5 Best Practices for Efficient Model Training](../by-focus-area/pretraining-and-architecture.md#dbx-r-5-best-practices-for-efficient-model-training) | `dbx-r-5-best-practices-for-efficient-model-training` |
| ? | [Best Practices (Dec 2021)](../by-focus-area/pretraining-and-architecture.md#dbx-r-best-practices-dec-2021) | `dbx-r-best-practices-dec-2021` |
| ? | [Dream3D](../by-focus-area/pretraining-and-architecture.md#dbx-r-dream3d) | `dbx-r-dream3d` |
| ? | [Making ML Training Efficient Algorithmically](../by-focus-area/pretraining-and-architecture.md#dbx-r-making-ml-training-efficient-algorithmically) | `dbx-r-making-ml-training-efficient-algorithmically` |
| ? | [Methodology](../by-focus-area/pretraining-and-architecture.md#dbx-r-methodology) | `dbx-r-methodology` |
| ? | [Natural Synthetics](../by-focus-area/pretraining-and-architecture.md#dbx-r-natural-synthetics) | `dbx-r-natural-synthetics` |
| ? | [Training Stable Diffusion from Scratch (Part 3)](../by-focus-area/pretraining-and-architecture.md#dbx-r-stable-diffusion-part-3) | `dbx-r-stable-diffusion-part-3` |
| ? | [Train Custom GPT + Diffusion Models](../by-focus-area/pretraining-and-architecture.md#dbx-r-train-custom-gpt-diffusion-models) | `dbx-r-train-custom-gpt-diffusion-models` |
...
| Date | Title | ID |
|---|---|---|
| 2026-04-14 | [Agentic Reasoning in Practice: Making Sense of Structured and Unstructured Data](../by-focus-area/agentic-systems.md#dbx-r-agentic-reasoning-practice-making-sense-structured-and-unstructured-data) | `dbx-r-agentic-reasoning-practice-making-sense-structured-and-unstructured-data` |
| 2026-04-10 | [Memory Scaling for AI Agents](../by-focus-area/agentic-systems.md#dbx-r-memory-scaling-ai-agents) | `dbx-r-memory-scaling-ai-agents` |
...
| 2023-10-17 | [LLM Training on Unity Catalog data with MosaicML Streaming Dataset](../by-focus-area/harness-and-context-engineering.md#dbx-e-llm-training-unity-catalog-data-mosaicml-streaming-dataset) | `dbx-e-llm-training-unity-catalog-data-mosaicml-streaming-dataset` |
| 2023-10-12 | [LLM Inference Performance Engineering: Best Practices](../by-focus-area/harness-and-context-engineering.md#dbx-e-llm-inference-performance-engineering-best-practices) | `dbx-e-llm-inference-performance-engineering-best-practices` |
| 2023-06-30 | [Training LLMs with AMD MI250 GPUs and MosaicML](../by-focus-area/harness-and-context-engineering.md#dbx-e-amd-mi250) | `dbx-e-amd-mi250` |
| 2023-05-23 | [Cloudflare R2 and MosaicML: Train LLMs on Any Compute with Zero Switching Costs](../by-focus-area/harness-and-context-engineering.md#dbx-e-cloudflare-r2-mosaicml) | `dbx-e-cloudflare-r2-mosaicml` |
| 2023-04-28 | [How We Trained Stable Diffusion for Less than $50k (Part 3)](../by-focus-area/harness-and-context-engineering.md#dbx-r-diffusion) | `dbx-r-diffusion` |
| 2022-08-11 | [Mosaic LLMs (Part 1): Billion-Parameter GPT Training Made Easy](../by-focus-area/harness-and-context-engineering.md#dbx-e-billion-parameter-gpt-training-made-easy) | `dbx-e-billion-parameter-gpt-training-made-easy` |
| 2022-06-23 | [Farewell, CUDA OOM: Automatic Gradient Accumulation](../by-focus-area/harness-and-context-engineering.md#dbx-e-farewell-oom) | `dbx-e-farewell-oom` |
| ? | [Composer on AWS](../by-focus-area/harness-and-context-engineering.md#dbx-e-aws-composer) | `dbx-e-aws-composer` |
| ? | [Composer 0.10 Release](../by-focus-area/harness-and-context-engineering.md#dbx-e-composer-0-10-release) | `dbx-e-composer-0-10-release` |
| ? | [Composer 0.11 Release](../by-focus-area/harness-and-context-engineering.md#dbx-e-composer-0-11-release) | `dbx-e-composer-0-11-release` |
| ? | [Composer 0.9 Release](../by-focus-area/harness-and-context-engineering.md#dbx-e-composer-0-9-release) | `dbx-e-composer-0-9-release` |
| ? | [Composer + FFCV: Faster Together](../by-focus-area/harness-and-context-engineering.md#dbx-e-composer-ffcv-faster-together) | `dbx-e-composer-ffcv-faster-together` |
| ? | [How We Trained Stable Diffusion for Less than $50k (Part 1)](../by-focus-area/harness-and-context-engineering.md#dbx-r-stable-diffusion-1) | `dbx-r-stable-diffusion-1` |
| ? | [Supercharge Training with Composer](../by-focus-area/harness-and-context-engineering.md#dbx-e-supercharge-training-composer) | `dbx-e-supercharge-training-composer` |
